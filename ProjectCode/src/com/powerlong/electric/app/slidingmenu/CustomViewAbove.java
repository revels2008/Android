/**
 * 宝龙电商
 * com.powerlong.electric.app.slidingmenu
 * CustomViewAbove.java
 * 
 * 2013-7-24-上午09:34:34
 *  2013宝龙公司-版权所有
 * 
 */
package com.powerlong.electric.app.slidingmenu;

import java.util.ArrayList;
import java.util.List;

import com.powerlong.electric.app.slidingmenu.SlidingMenu.OnClosedListener;
import com.powerlong.electric.app.slidingmenu.SlidingMenu.OnOpenedListener;
...
//		setDescendantFocusability(FOCUS_AFTER_DESCENDANTS);
	...
	void smoothScrollTo(int x, int y, int velocity) {
		...
		LogUtil.d("scroll", "velocity = "+velocity);
		if (velocity > 0) {
		...
		LogUtil.d("scroll", "duration = "+duration);
		duration = Math.min(duration, MAX_SETTLE_DURATION);
		LogUtil.d("scroll", "duration min = "+duration);
...
//		mContent.setClickable(true);
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			try{
				...
				if (DEBUG) Log.v(TAG, "pointerIndex = "+pointerIndex);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (DEBUG) Log.v(TAG, "mActivePointerId = " + mActivePointerId);
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		...
		if (DEBUG) Log.v(TAG, "dispatchKeyEvent");
