 ...
 * 
 */
public class PlBannerLayout extends AdapterView<Adapter> {
	...
	public PlBannerLayout(Context context) {
		super(context);
		mSideBuffer = 3;
		init();
	}

	public PlBannerLayout(Context context, int sideBuffer) {
		super(context);
		mSideBuffer = sideBuffer;
		init();
	}

	public PlBannerLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray styledAttrs = context.obtainStyledAttributes(attrs,
				R.styleable.PlBannerLayout);
		mSideBuffer = styledAttrs.getInt(R.styleable.PlBannerLayout_sidebuffer, 3);
		init();
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		LogUtil.i("PlBannerLayout", "onInterceptTouchEvent" );
		if (getChildCount() == 0)
			return false;
		...
		case MotionEvent.ACTION_DOWN:
			LogUtil.i("PlBannerLayout", "ACTION_DOWN" );
			...
			mLastMotionX = x;
			mLastMotionY = y;
			LogUtil.i("PlBannerLayout", "mLastMotionY = "+mLastMotionY );
		...
		case MotionEvent.ACTION_MOVE:
			LogUtil.i("PlBannerLayout", "ACTION_MOVE");
			LogUtil.i("PlBannerLayout", "y = "+y );
			LogUtil.i("PlBannerLayout", "mLastMotionY = "+mLastMotionY );
			LogUtil.i("PlBannerLayout", "mTouchSlop = "+mTouchSlop );
		...
		case MotionEvent.ACTION_UP:
			LogUtil.i("PlBannerLayout", "ACTION_UP" );
			onTouch = false;
			if (mTouchState == TOUCH_STATE_SCROLLING) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		LogUtil.d("PlBannerLayout","onTouchEvent");
		if (getChildCount() == 0)
			return false;
		...
		switch (action) {
		case MotionEvent.ACTION_DOWN:
			LogUtil.d("PlBannerLayout","onTouchEvent ACTION_DOWN");
			onTouch = true; // 点击到viewflow的区域中
		...
		case MotionEvent.ACTION_UP:
			LogUtil.d("PlBannerLayout","onTouchEvent ACTION_UP");
