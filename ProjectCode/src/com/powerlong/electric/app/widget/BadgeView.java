...
/**
 * 
 * BadgeView A simple text label view that can be applied as a "badge" to any given {@link android.view.View}. 
...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#FCB815");;
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			//lp.height = lp.height + badgeMarginV;
			//lp.width = lp.width + badgeMarginH;
	...
	private void applyLayoutParams() {
		...
		//LayoutParams lpTarget = target.getLayoutParams();
		//int tHieght = lpTarget.height;
		//int tWidth = lpTarget.width;
