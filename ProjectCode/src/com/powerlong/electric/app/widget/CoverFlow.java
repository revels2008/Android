...
import com.powerlong.electric.app.adapter.AbstractCoverFlowImageAdapter;
...
public class CoverFlow extends Gallery {
    ...
    private int getCenterOfCoverflow() {
    	Log.v("CoverFloew" ,"getWidth = " + getWidth());
    	Log.v("CoverFloew" ,"getPaddingLeft = " + getPaddingLeft());
    	Log.v("CoverFloew" ,"getPaddingRight = " + getPaddingRight());
        
        return (int) ((getWidth() - getPaddingLeft() - getPaddingRight()) / 2 + getPaddingLeft());
    }
    ...
    private static int getCenterOfView(final View view) {
    	Log.v("CoverFloew" ,"getCenterOfView getLeft = " + view.getLeft());
    	Log.v("CoverFloew" ,"getCenterOfView getWidth = " + view.getWidth());
    ...
    private void parseAttributes(final Context context, final AttributeSet attrs) {
        ...
        try {
            imageWidth = a.getDimension(R.styleable.CoverFlow_imageWidth, 720);
            imageWidth = imageWidth;
            Log.v("CoverFloew" ,"imageWidth = " + imageWidth);
            imageHeight = a.getDimension(R.styleable.CoverFlow_imageHeight, 4);
            imageHeight = imageHeight;
            Log.v("CoverFloew" ,"imageHeight = " + imageHeight);
//            withReflection = a.getBoolean(R.styleable.CoverFlow_withReflection, false);
            withReflection = false;
            Log.v("CoverFloew" ,"withReflection = " + withReflection);
            imageReflectionRatio = a.getFloat(R.styleable.CoverFlow_imageReflectionRatio, 0.2f);
            Log.v("CoverFloew" ,"imageReflectionRatio = " + imageReflectionRatio);
            reflectionGap = a.getDimension(R.styleable.CoverFlow_reflectionGap, 4);
            Log.v("CoverFloew" ,"reflectionGap = " + reflectionGap);
            setSpacing(-15);
        } finally {
            a.recycle();
        }
