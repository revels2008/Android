 ...
 * JSONUtil:Json工具类
 * 
 * @author: Liang Wang 2013-8-7-下午04:36:58
 * 
 * @version 1.0.0
 * 
 */
public class JSONUtil {
	private static String LOG_TAG = JSONUtil.class.getName();
	/**
	 ...
	 *         <li>若jsonData {@link JSONObject#JSONObject(String)}
	 *         异常，返回defaultValue</li>
	 ...
	 *         <li>若jsonData {@link JSONObject#JSONObject(String)}
	 *         异常，返回defaultValue</li>
	 *         <li>调用{@link JSONUtils#getString(JSONObject, String, JSONObject)}
	 *         </li>
	 *         </ul>
	 */
	...
	public static Map<String, String> parseKeyAndValueToMap(JSONObject sourceObj) {
		...
		for (Iterator iter = sourceObj.keys(); iter.hasNext();) {
			...
			MapUtil.putMapNotEmptyKey(keyAndValueMap, key,
