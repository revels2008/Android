...
/**
 * 
 * MapUtil:map工具类，用于实现一些map的常用操作
 * 
 * @author: Liang Wang 2013-8-7-下午04:38:11
 * 
 * @version 1.0.0
 * 
 */
public class MapUtil {
	...
	/**
	 * 向map中put key和value对，key必须非null，并且为非空字符串，若value为null或者空字符串，put
	 * defaultValue
	 * 
	 * @param map
	 * @param key
	...
	/**
	 * 向map中put key和value对，key必须非null
	 * 
	 * @param map
	 * @param key
	 * @param value
	 ...
	 *         <ul>
	 *         <li>若map为null，返回false，否则</li>
	 *         <li>若key为null，返回false，否则</li>
	 *         <li>调用{@link Map#put(Object, Object)} 返回true</li>
	 *         </ul>
	 */
	public static <K, V> boolean putMapNotEmptyKey(Map<K, V> map, K key, V value) {
	...
	/**
	 * 向map中put key和value对，key和value都必须非null
	 * 
	 * @param map
	 * @param key
	 * @param value
	 ...
	 *         </ul>
	 */
	public static <K, V> boolean putMapNotEmptyKeyAndValue(Map<K, V> map,
			K key, V value) {
	 ...
	 * 
	 * <strong>注意：</strong>
	 * 由于对于一般的HashMap，元素的顺序并不是put的顺序，所以使用本函数得到的值并不是第一次put的值，
	 * 如果想得到第一次put的值，请使用TreeMap<br/>
	 * <br/>
	 * 
	 * @param <V>
	 * @param map
	 ...
	 * @see <ul>
	 *      <li>见
	 *      {@link StringUtil#parseKeyAndValueToMap(String, String, String, boolean)}
	 *      </li>
	 *      </ul>
	 */
	public static Map<String, String> parseKeyAndValueToMap(String source,
