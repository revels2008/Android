 ...
 * 
 */
public class NavigationShopAdapter extends BaseAdapter {
	private List<NavigationFloorDetailsEntity> mList;
	private Context mContext;
	private LayoutInflater mInflater; 
	public NavigationShopAdapter(Context context, List<NavigationFloorDetailsEntity> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.name.setText(mList.get(position).getShopName());
//			holder.num.setText(mList.get(position).ge+"");
			convertView.setMinimumHeight(134);
