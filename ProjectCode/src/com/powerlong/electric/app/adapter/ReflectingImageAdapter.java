...
public class ReflectingImageAdapter extends AbstractCoverFlowImageAdapter {
    ...
    protected Bitmap createBitmap(final int position) {
    	Log.v(ReflectingImageAdapter.class.getName(), "createBitmap at position: " + position);
	...
	protected ImageView getImageView(int position) {
		...
		return linkedAdapter.getImageView(position);
	}
	...
	protected ArrayList<ImageView> getImageViews() {
		// TODO Auto-generated method stub
		return linkedAdapter.getImageViews();
	}*/
