...
public class BaseDialog extends Dialog implements
	...
	private HandyTextView mHtvSubTitle;// 副标题
	...
	private void initViews() {
		...
		mHtvSubTitle = (HandyTextView)findViewById(R.id.dialog_generic_htv_subtitle);
	...
	public void setSubTitle(CharSequence text){
		if (text != null) {
			mLayoutTitle.setVisibility(View.VISIBLE);
			String pricePrfix = mContext.getResources().getString(R.string.str_price_prifix);
			mHtvSubTitle.setText(String.format(pricePrfix, text));
