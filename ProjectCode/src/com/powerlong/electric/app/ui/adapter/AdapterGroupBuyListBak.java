 ...
 * 
 */
public class AdapterGroupBuyListBak<T> extends AdapterBaseCommon<T>{
	private DecimalFormat decimalFormat;
	
	public AdapterGroupBuyListBak(Context context){
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup viewgroup) {
		...
		vh.tv_pl_price.setText("价值 "+Constants.moneyTag+list_price);
