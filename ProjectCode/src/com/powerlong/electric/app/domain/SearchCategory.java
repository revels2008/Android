...
public class SearchCategory {
	public static List<SearchCategory> convertJsonToSearCategory(Context context,String json){
		...
		try {
			...
			for(int i = 0;i<jsArr.length();i++){
				...
				searchCategory.setSearCategorySub(jsObj.optString("searCategorySub", ""));
	...
	public String getSearCategorySub() {
		return searCategorySub;
	}
	public void setSearCategorySub(String searCategorySub) {
		this.searCategorySub = searCategorySub;
	}
}
