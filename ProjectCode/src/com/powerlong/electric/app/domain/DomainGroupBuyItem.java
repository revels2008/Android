...
public class DomainGroupBuyItem {
	public static List<DomainGroupBuyItem> convertJsonToGroupBuyItemList(Context context,String json){
		List<DomainGroupBuyItem> list = new ArrayList<DomainGroupBuyItem>();
		try {
			JSONArray jsArr = new JSONArray(json);
			for(int i=0; i<jsArr.length();i++ ){
				DomainGroupBuyItem groupBuyItem = new DomainGroupBuyItem();
