 ...
 * 
 */
public class SearchCategorySub {
	public static List<SearchCategorySub> convertJsonToSearchCategorySub(String json){
		List<SearchCategorySub> list = new ArrayList<SearchCategorySub>();
		try {
