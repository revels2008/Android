 ...
 * NavigationShoppingDao.java
 * 
 * 2013-8-20-上午10:27:06
 *  2013宝龙公司-版权所有
 * 
 */
...
public class NavigationShoppingDao extends BaseDaoImpl<NavigationShoppingEntity> {
	...
	/**
	 * 创建一个新的实例 NavigationShoppingDao.
	 *
	 * @param dbHelper
	 */
	public NavigationShoppingDao(SQLiteOpenHelper dbHelper) {
		super(dbHelper);
	 ...
	 * 根据所属ID获得附件列表
	 */
	public ArrayList<NavigationShoppingEntity> getBySelfId(String selfId)
	{
	 ...
	 * 
	 */
	public boolean add(NavigationShoppingEntity entity)
	{
		insert(entity);
		return true;
	}
