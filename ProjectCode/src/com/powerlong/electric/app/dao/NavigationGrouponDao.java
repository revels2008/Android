 ...
 * NavigationGrouponDao.java
 * 
 * 2013-8-20-上午10:23:25
 *  2013宝龙公司-版权所有
 * 
 */
...
public class NavigationGrouponDao extends BaseDaoImpl<NavigationGrouponEntity> {
	...
	/**
	 * 创建一个新的实例 NavigationGrouponDao.
	 *
	 * @param dbHelper
	 */
	public NavigationGrouponDao(SQLiteOpenHelper dbHelper) {
		super(dbHelper);
	 ...
	 * 根据所属ID获得附件列表
	 */
	public ArrayList<NavigationGrouponEntity> getBySelfId(String selfId)
	{
	 ...
	 * 
	 */
	public boolean add(NavigationGrouponEntity entity)
	{
		insert(entity);
		return true;
	}
