...
public class FinderPatternFinder {
    ...
    FinderPatternInfo find(Map<DecodeHintType, ?> hints) throws NotFoundException {
        ...
        // number of pixels the center could be, so skip this often. When trying harder, look for
        // all
                                ...
                                if (confirmed) {
                                    ...
                                    if (hasSkipped) {
                                        ...
                                        if (rowSkip > stateCount[2]) {
                                            ...
                                            // of last center
                                            // of pattern we saw) to be conservative, and also back
                                            // off by iSkip which
    ...
    private float crossCheckHorizontal(int startJ, int centerI, int maxCount,
        ...
        int stateCountTotal = stateCount[0] + stateCount[1] + stateCount[2] + stateCount[3]
                + stateCount[4];
        if (5 * Math.abs(stateCountTotal - originalStateCountTotal) >= originalStateCountTotal) { return Float.NaN; }
     ...
     * scan. This is needed primarily to locate the real horizontal center of the pattern in cases
     * of extreme skew.
     * </p>
     * 
     * <p>
     ...
     * </p>
     */
    private static class FurthestFromAverageComparator implements Comparator<FinderPattern>,
            Serializable {
