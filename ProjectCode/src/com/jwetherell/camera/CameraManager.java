...
import com.jwetherell.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        return new PlanarYUVLuminanceSource(data, width, height, rect.left, rect.top, rect.width(),
                rect.height(), Preferences.KEY_REVERSE_IMAGE);
    }
    ...
    public void turnOnTorch() {
        ...
        configManager.setTorch(camera, true);
    }
    ...
    public void turnOffTorch() {
        ...
        configManager.setTorch(camera, false);
    }
}
