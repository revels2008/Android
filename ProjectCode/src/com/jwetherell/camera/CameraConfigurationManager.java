...
public final class CameraConfigurationManager {
    ...
    void setTorch(Camera camera, boolean newSetting) {
    	try{
	    	Camera.Parameters parameters = camera.getParameters();
	        if(newSetting) {
	            doSetTorchOn(parameters);
	        }
	        else {
	            doSetTorchOff(parameters);
	        }
...
//            doSetTorchOff(parameters);
//        }
        Preferences.KEY_FRONT_LIGHT = false;
        doSetTorchOff(parameters);
    }

    private static void doSetTorchOn(Camera.Parameters parameters) {
        String flashMode;
    ...
    private static void doSetTorchOff(Camera.Parameters parameters) {
        String flashMode;
        flashMode = findSettableValue(parameters.getSupportedFlashModes(),
